...
//load svg file
document.getElementById("faqBtn").addEventListener(
	"load",
	function () {
		var svgDoc = this.contentDocument; // Get the SVG document
		var svgPath = svgDoc.querySelector("path"); // Get the path element
		svgPath.setAttribute("fill", "#b6795d"); // Change the fill color
	},
	true
);
